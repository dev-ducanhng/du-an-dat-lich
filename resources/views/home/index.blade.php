                ...
                @foreach ($models as $item)
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="single-product-item">
                            ...
                            <p>
                                <span> <span style="color: #F28123;font-size: 1.5rem">{{$item->priceDiscount}} đ</span> <span
                                        style="color: rgb(214, 211, 211) ;font-size: 1.5rem;text-decoration: line-through"> {{$item->price}} đ</span> </span>
                            </p>
                            @endif</p>

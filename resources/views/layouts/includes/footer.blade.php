        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="footer-box about-widget">
                    <h2 class="widget-title">Giờ làm việc</h2>
                    <p>Thứ 2 đến thứ 6: 8h00 - 21h00<br />
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-box subscribe">
                    ...
                    <p>Số điện thoại: 098224212</p>
                    <p>Hoặc liên hệ qua email</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <p>Copyrights &copy; 2022 - <a href="https://imransdesign.com/">ISALON</a></p>
            </div>

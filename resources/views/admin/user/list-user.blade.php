                    ...
                    <div class="mb-3">
                        <div class="text-zero top-right-button-container">
                            <a href="{{ route('dashboard.user.create') }}"
                                class="btn btn-primary btn-lg top-right-button mr-1 text-white">Thêm người dùng</a>
                        </div>
                        ...
                        <div class="card d-flex flex-row mb-3">
                            <a class="d-flex align-items-center ml-2">
                                @if (strpos($user->avatar, 'user-default-avatar.jpg') != false)
                                    <img src="{{ asset($user->avatar) }}" alt="Fat Rascal"
                            ...
                            <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                <div
                                    ...
                                    <div class="w-15 w-sm-100">
                                        <span
                                            class="badge badge-pill {{ $user->status == \App\Models\User::ACTIVE ? 'badge-success' : 'badge-primary' }}">
                                            {{ $user->status == \App\Models\User::ACTIVE ? 'Hoạt động' : 'Không hoạt động' }}
                                        </span>
                                    </div>
                                </div>
                                <div class="btn-group">
                                    <button class="btn d-flex justify-content-center align-items-center  dropdown-toggle"
                                        style="vertical-align: center" type="button" data-toggle="dropdown"
